class OwnersController < ApplicationController
  ...
  # But in order to avoid having to add an authorize! in every action, we use authorize_resource  
   authorize_resource #loads the ability content and execute an authorize! for every action.
