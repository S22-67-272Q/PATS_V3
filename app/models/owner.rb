class Owner < ApplicationRecord
  ...
  # Delegation
  # The Active Record delegate method provides a delegate class method to easily expose contained objects' public
  # methods as your own. 
  # Simply say, through delegation you can use public methods in other model directly.
  # In this case, we are making sure that the owner can have the username specified to it in the User model
  # we can do: Owner.first.username and get the username, without having to use the user relationshop 
  # Owner.first.user.username
